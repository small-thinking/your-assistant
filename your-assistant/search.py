...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Process input string for AI assistant')
    parser.add_argument('-i', '--input_string', required=True, help='Input string for AI assistant')
